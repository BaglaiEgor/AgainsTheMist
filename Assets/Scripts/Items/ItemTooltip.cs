...
public class ItemTooltip : MonoBehaviour
{
    ...
    void FollowCursor()
    {
        ...
        if (useLeftBottomPosition)
        {
            rect.anchoredPosition = pos + (leftBottomOffset / scale);
            return;
        }
    ...
    {
        ShowCustomInternal(header, description, extra, false);
    }

    public void ShowCustomLeftBottom(string header, string description, string extra)
    {
    ...
    {
        isCustomMode = true;
        useLeftBottomPosition = leftBottomPosition;
        displayedItem = null;
