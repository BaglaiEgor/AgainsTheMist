...
public class ChestInventoryUI : MonoBehaviour
{
    ...
    {
        HandleFastTransfer(index);
    }

    public void HandleSlotLeftClick(int index)
    {
        if (inventoryUI == null || currentChest == null)
            return;

        inventoryUI.HandleSlotLeftClick(currentChest, index);
    }

    public void HandleSlotRightClick(int index)
    {
        if (inventoryUI == null || currentChest == null)
            return;

        inventoryUI.HandleSlotRightClick(currentChest, index);
    }

    public bool HandleFastTransfer(int index)
    {
        if (inventoryUI == null || currentChest == null)
            return false;

        return inventoryUI.HandleFastTransfer(currentChest, index);
    }
    ...
    public void SetHoveredSlot(int index)
    {
        ...
        inventoryUI.SetHoveredSlot(currentChest, index);
    }
    ...
    public void ClearHoveredSlot(int index)
    {
        ...
        inventoryUI.ClearHoveredSlot(currentChest, index);
    }
