...
public class PotionEffectsUI : MonoBehaviour
{
    ...
    void EnsureView(int index, EffectSlot slot, string fallbackName)
    {
        ...
        PotionEffectHoverTarget hoverTarget = viewObject.GetComponent<PotionEffectHoverTarget>();
        if (hoverTarget == null)
            hoverTarget = viewObject.AddComponent<PotionEffectHoverTarget>();

        hoverTarget.Initialize(slot, OnEffectHoverEnter, OnEffectHoverExit);
    ...
    void ShowTooltipForHovered()
    {
        ...
        sharedTooltip.ShowCustom(name, description, extra);
    }
...
public class PotionEffectHoverTarget : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    private PotionEffectsUI.EffectSlot slot;
    private System.Action<PotionEffectsUI.EffectSlot> onEnter;
    private System.Action<PotionEffectsUI.EffectSlot> onExit;

    public void Initialize(
        PotionEffectsUI.EffectSlot slot,
        System.Action<PotionEffectsUI.EffectSlot> onEnter,
        System.Action<PotionEffectsUI.EffectSlot> onExit)
    {
        this.slot = slot;
